...
- **Hardware Used:**
  ...
  - 16x2 LCD display  
- [Click here for more details.](./Project%201%20isim%20yazdırma)
...
- **Hardware Used:**
  - Tiva C Series LaunchPad  
  - 16x2 LCD display  
- [Click here for more details.](./Project%202%20Saat)
...
- **Hardware Used:**
  - Tiva C Series LaunchPad  
  - 16x2 LCD display  
- [Click here for more details.](./Project%203%20ADC%20Değer%20Okuma)
...
- **Hardware Used:**
  ...
  - 16x2 LCD display  
- [Click here for more details.](./Project%204%20Seri%20Port%20Haberleşme)
...
### 1. **16x2 LCD Kullanımı**
   ...
   - **Kullanılan Donanım:**
     ...
     - 16x2 LCD ekran
   - [Detaylar için buraya tıklayın.](./Project%201%20isim%20yazdırma)
...
### 2. **Mikrodenetleyici ile Temel Saat Uygulaması**
   ...
   - **Kullanılan Donanım:**
     - Tiva C Serisi LaunchPad
     - 16x2 LCD ekran
   - [Detaylar için buraya tıklayın.](./Project%202%20Saat)
...
### 3. **Seri Port ile Saat Gönderimi**
   ...
   - **Kullanılan Donanım:**
     - Tiva C Serisi LaunchPad
     - 16x2 LCD ekran
   - [Detaylar için buraya tıklayın.](./Project%203%20ADC%20Değer%20Okuma)
...
### 4. **Seri Port ile Saat ve Metin Gönderimi**
   ...
   - **Kullanılan Donanım:**
     ...
     - 16x2 LCD ekran
   - [Detaylar için buraya tıklayın.](./Project%204%20Seri%20Port%20Haberleşme)
